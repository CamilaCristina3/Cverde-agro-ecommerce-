...
def create_producer_review(request, producer_id):
    ...
    if existing_review:
        ...
        return redirect('users:producer_detail', producer_id=producer_id)
...
def product_reviews(request, product_id):
    ...
    stats = reviews.aggregate(
        ...
        five_star=Count('id', filter__rating=5),
        four_star=Count('id', filter__rating=4),
        three_star=Count('id', filter__rating=3),
        two_star=Count('id', filter__rating=2),
        one_star=Count('id', filter__rating=1),
    )
